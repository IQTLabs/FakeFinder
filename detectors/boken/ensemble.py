...
class Ensemble(DeeperForensicsDetector):
    def __init__(self):
        ...
        if not self.is_ensamble:
            ...
            model_path = './weights/output_my_aug/efn-b0_LS_27_loss_0.2205.pth'
            ...
            self.models = self.load_models(model_names=['efficientnet-b0', 'efficientnet-b1', 'efficientnet-b2'],
                                           model_paths=['./weights/output_my_aug/efn-b0_LS_27_loss_0.2205.pth',
                                                        './weights/output_my_aug/efn-b1_LS_6_loss_0.1756.pth',
                                                        './weights/output_my_aug/efn-b2_LS_12_loss_0.1728.pth'])
